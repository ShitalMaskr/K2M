...
jQuery($ => {
    ...
    $("#submit_btn1 , #submit_btn").on('click', function () {
        ...
        if (proceed) {
            postData = {
                "domain": "cherrype.com",
                "subject": "Sending Email using assimilate email service for testing",
                "text": "assimilate email service",
                "html": "<p>Assimilate Technologies</p>",
                'to': userEmail,
                'text': userMessage
            };
            ...
            $.ajax({
                type: 'POST',
                url: 'https://8dsaabuzz8.execute-api.ap-south-1.amazonaws.com/sendEmail',
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    ...
                    output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">Failed to contact the server.</div>';
                    result.slideUp("fast").html(output).slideDown();
                }
            });
